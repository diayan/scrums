...
//You’ve used @State to create a source of truth for value type models.
...
//The ScrumTimer class periodically updates the state of a meeting.
//The timer calls the speakerChangedAction closure when the speaker changes and shares other important state
//changes through @Published properties.
